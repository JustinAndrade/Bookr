    ...
    return (
      <div>
        ...
        <Modal
          className="sign-in"
          isOpen={loginOpened}
          onRequestClose={this.closeModal("sign-in")}
          size="lg"
        >
          <ModalBody>
            <div className="modal-container">
              ...
              <div className="modal-info">
                <div>
                  <button
                    className="close"
                    onClick={this.closeModal("sign-in")}
                  >
                    ×
                  </button>
                </div>
                ...
                <div className="modal-form">
                  ...
                  <div className="register-portal">
                    <span>
                      New to Bookr?{"  "}
                      <a onClick={this.openModal("register")}>
                        Create an account.
                      </a>
                    </span>
                  </div>
            ...
            <div className="modal-container">
              ...
              <div className="modal-info">
                <div>
                  <button
                    className="close"
                    onClick={this.closeModal("register")}
                  >
                    ×
                  </button>
                </div>
                ...
                <div className="modal-register-form">
                  ...
                  >
                    <FormText>
                      By creating a Bookr account, you can discover, critique,
                      and recommend books from a wide variety of authors and
                      genres.
                    </FormText>
                    <br />
                    ...
                    <Button
                      type="submit"
                      color="primary"
                      onClick={this.openModal("sign-in")}
                    >
        ...
        <div className="nav-buttons">
          ...
          <button onClick={this.openModal("register")}>Get started</button>
        </div>
      </div>
    );
  }
